...
export function drawAnnotationPreview(canvas, scene) {
  ...
  if (showPlate) {
    drawSoftBacking([textBox[0] - 8, textBox[1] - 4, textBox[2] + 8, textBox[3] + 4],
  ...
  const bh0 = bubbleBox[3] - bubbleBox[1]
  const decoPos = [
    [bubbleBox[0] + decoSize * 0.3, bubbleBox[1] + bh0 * 0.12],
    [bubbleBox[2] - decoSize * 0.3, bubbleBox[1] + bh0 * 0.06],
  ]
  deco.slice(0, 2).forEach((d, i) => {
